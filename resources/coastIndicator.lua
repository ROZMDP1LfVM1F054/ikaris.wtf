...
function lib:newIndicator(title)
    ...
    MainFrame.BackgroundColor3 = Color3.fromRGB(31, 28, 54)
    ...
    StatsSection.BackgroundColor3 = Color3.fromRGB(24, 21, 48)
    ...
    MainFrameGlow3.BackgroundColor3 = Color3.fromRGB(31, 28, 54)
    ...
    MainFrameGlow3.ImageColor3 = Color3.fromRGB(31, 28, 54)
    ...
    MainFrameGlow2.BackgroundColor3 = Color3.fromRGB(31, 28, 54)
    ...
    MainFrameGlow2.ImageColor3 = Color3.fromRGB(31, 28, 54)
    ...
    MainFrameGlow1.Parent = MainFrame
    MainFrameGlow1.BackgroundColor3 = Color3.fromRGB(31, 28, 54)
    MainFrameGlow1.BackgroundTransparency = 2.000
    MainFrameGlow1.Position = UDim2.new(-0.0973860696, 0, -0.0767357051, 0)
    MainFrameGlow1.Size = UDim2.new(0, 178, 0, 212)
    MainFrameGlow1.ZIndex = 0
    MainFrameGlow1.Image = "rbxassetid://5028857084"
    MainFrameGlow1.ImageColor3 = Color3.fromRGB(31, 28, 54)
    ...
    function libaray:createIndicator(value)
        ...
        StatFrame1.BackgroundColor3 = Color3.fromRGB(29, 26, 53)
        ...
        StatsTitle1.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
